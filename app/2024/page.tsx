...
export default function QiskitFallFest2024() {
        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-75 backdrop-blur-md">
          <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <ul className="hidden md:flex items-center space-x-6">
              ...
              <li>
                <EditionDropdown currentYear="2024" textColor="text-white" />
              </li>
            </ul>
          </nav>
        </header>
          ...
          >
            <div className="text-center">
              ...
              >
                ...
                <Button className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-full transition-colors text-lg cursor-not-allowed">
                  Event Completed
                </Button>
              </motion.div>
            </div>
          ...
          >
            <div className="container mx-auto">
              ...
              <h3 className="my-6 text-center font-semibold text-purple-300 text-lg">
                Beyond Bits was a Qiskit Fall Fest 2024 Extension Event
                ...
                <br />
                Beyond Bits featured hands-on quantum computing workshops,
